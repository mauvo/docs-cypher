...
The `IS NOT NULL` predicate provides the same semantics as the optional GQL property existence predicate (GQL feature G115).
For details, see xref:appendix/gql-conformance/supported-optional.adoc#g115[GQL conformance -> Supported optional GQL features (G115)].
