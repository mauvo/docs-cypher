...
Using `IS NOT NULL` on a property (e.g. `n.prop IS NOT NULL`) tests that the property exists and is not null, and is conformant with the optional GQL property existence predicate (xref:appendix/gql-conformance/supported-optional.adoc#g115[GQL feature G115]).
